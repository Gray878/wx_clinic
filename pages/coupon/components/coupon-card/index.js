...
Component({
  ...
  methods: {
    ...
    gotoDetail() {
      wx.navigateTo({
        url: `/packageCoupon/pages/coupon/coupon-detail/index?id=${this.data.couponDTO.key}`,
      });
    },
    ...
    gotoGoodsList() {
      wx.navigateTo({
        url: `/packageCoupon/pages/coupon/coupon-activity-goods/index?id=${this.data.couponDTO.key}`,
      });
    },
  },
});
